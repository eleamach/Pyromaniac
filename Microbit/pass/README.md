...
The present program main.cpp read a json from radio with a string separator between each crypted part :

- When data is received, it checks if the message starts with "1857:" 
- Secondly, split the message when it encounter this separator "+*_*+".
- Then, each part of the message is decrypted and made in a whole string.
- Finally it is send through serial.
